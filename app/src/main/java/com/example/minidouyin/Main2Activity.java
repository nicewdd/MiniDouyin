...
import static com.example.minidouyin.Utils.MEDIA_TYPE_IMAGE;
import static com.example.minidouyin.Utils.MEDIA_TYPE_VIDEO;
import static com.example.minidouyin.Utils.getOutputMediaFile;
...
//        mCamera = getCamera(cameraId);
        ...
        findViewById(R.id.btn_picture).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                closeFlash();
                Toast.makeText(Main2Activity.this, "已保存至手机", Toast.LENGTH_LONG).show();
            }
        });
        ...
        findViewById(R.id.btn_record).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isRecording) {
                    ...
                    mMediaRecorder = null;
                    mCamera.lock();
                    Toast.makeText(Main2Activity.this, "结束录制", Toast.LENGTH_LONG).show();
                    isRecording = false;
                } else {
                    //todo 录制
                    Toast.makeText(Main2Activity.this, "开始录制", Toast.LENGTH_LONG).show();
        ...
        findViewById(R.id.btn_zoom).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mCamera.getParameters().isZoomSupported()){
                    Toast.makeText(Main2Activity.this, "开始调焦", Toast.LENGTH_LONG).show();
                    mCamera.autoFocus(myAutoFocusCallback);
                }
                else{
                    Toast.makeText(Main2Activity.this, "您的手机不支持变焦", Toast.LENGTH_LONG).show();
                }
            }
        });
...
//        parameters.setPictureSize(size.width, size.height);
    ...
    private void openFlash(){
        try{
            ...
            Toast.makeText(Main2Activity.this, "开启闪光灯失败", Toast.LENGTH_LONG).show();
        }
    }
    private void closeFlash(){
        try{
            ...
            Toast.makeText(Main2Activity.this, "关闭闪光灯失败", Toast.LENGTH_LONG).show();
        }
    }
